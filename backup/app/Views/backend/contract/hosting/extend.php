						...
						<div class="row">
							...
							<div class="col-lg-4 mb10">
								<div class="form-row uk-flex uk-flex-bottom ">
									...
									<?php echo form_input('date_start', set_value('date_end', (isset($contract_hosting['date_end'])) ? gettime($contract_hosting['date_end'], 'd/m/Y') : ''), 'class="form-control input" data-mask="99/99/9999" readonly  placeholder="ví dụ: 28/2/2020" autocomplete="off"');?>
								</div>
							</div>
						</div>
						<div class="row">
