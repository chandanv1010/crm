        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Quản lý Hợp Đồng Hosting </h5>
                            ...
                            <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
                                ...
                                <td class="text-center">
                                    <ul class="uk-list lta-tool">
                                        <li>
                                            <a type="button" href="<?php echo base_url('backend/contract/hosting/update/'.$val['id']) ?>" class="btn btn-primary open-window" title="Sửa"><i class="fa fa-edit"></i></a>
                                        </li>
                                        <li>
