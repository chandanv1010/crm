                ...
                <div class="ibox-content">
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/service/domain/create') ?>" class="btn btn-danger btn-sm "><i class="fa fa-plus"></i> Thêm Domain mới</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example object-list">
                        ...
                        <tr>
                            ...
                            <th class="text-right">Giá gia hạn</th>
                        ...
                        <tbody>
                            <?php if(isset($domainList) && is_array($domainList) && count($domainList)){ ?>
                            <?php foreach($domainList as $key => $val){ ?>
                            <?php  
                            ...
                            <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
                                ...
                                <td class="text-success text-right"><?php echo number_format($val['price_buy'], 0, ',', '.') ?> VNĐ</td> 
                                <td class="text-success text-right"><?php echo number_format($val['price_sell'], 0, ',', '.') ?> VNĐ</td>
                                 <td class="text-success text-right"><?php echo number_format($val['price_extend'], 0, ',', '.') ?> VNĐ</td>
                                <td class="text-right"><?php echo $val['creator'] ?></td>
                                <td class="text-right"><?php echo $val['created_at'] ?></td>
                                <td class="text-center">
                                    <a type="button" href="<?php echo base_url('backend/service/domain/update/'.$val['id']) ?>" class="btn btn-primary "><i class="fa fa-edit"></i></a>
                                    <a type="button" href="<?php echo base_url('backend/service/domain/delete/'.$val['id']) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php }}else{ ?>
                                <tr>
