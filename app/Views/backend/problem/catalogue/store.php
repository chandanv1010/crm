						...
						<div class="row mb15">
							<div class="col-lg-6">
								<div class="form-row uk-flex uk-flex-bottom">
									...
									<?php echo form_input('title', set_value('title', (isset($problem_catalogue['title'])) ? $problem_catalogue['title'] : ''), 'class="form-control input js_input" placeholder="" autocomplete="off"');?>
									<?php echo form_hidden('id', set_value('id', (isset($problem_catalogue['id'])) ? $problem_catalogue['id'] : 0), 'class="form-control input js_input" placeholder="" autocomplete="off"');?>
								</div>
							</div>
						</div>
					</div>
