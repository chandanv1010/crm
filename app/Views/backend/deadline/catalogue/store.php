					...
					<div class="ibox-title">
						<div class="uk-flex uk-flex-middle uk-flex-space-between js_change_text_to_input">
							<div class="uk-flex uk-flex-middle">
								<h5>Thông tin nhóm thời gian xử lý</h5>
							</div>
							<div class="uk-flex uk-flex-middle">
							...
							<div class="col-lg-6">
								<div class="form-row uk-flex uk-flex-bottom">
									<label class="control-label special text-left uk-flex uk-flex-middle">
										<span class="mr10">Tên nhóm: </span>
									</label>
									<?php echo form_input('title', set_value('title', (isset($deadline_catalogue['title'])) ? $deadline_catalogue['title'] : ''), 'class="form-control input js_input" placeholder="" autocomplete="off"');?>
									<?php echo form_hidden('id', set_value('id', (isset($deadline_catalogue['id'])) ? $deadline_catalogue['id'] : 0), 'class="form-control input js_input" placeholder="" autocomplete="off"');?>
								</div>
							</div>
						</div>
					</div>
