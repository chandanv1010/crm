...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-8">
      <h2>Quản Lý Hợp Đồng Domain</h2>
      <ol class="breadcrumb" style="margin-bottom:10px;">
         <li>
            <a href="<?php echo base_url('backend/dashboard/dashboard/index') ?>">Home</a>
         </li>
         <li class="active"><strong>Quản lý Hợp Đồng Domain</strong></li>
      </ol>
   </div>
</div>
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb10">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/contract/domain/create') ?>" class="btn btn-danger btn-sm open-window"><i class="fa fa-plus"></i> Thêm Hợp đồng Domain Mới</a>
                                        <!-- -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <tbody>
                            ...
                            <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
                                ...
                                <td style="color:blue;" class="show-infor">
                                    <div class="mb5"><span class="text">Giá Gói:</span> <span><?php echo number_format($val['price'], 0, ',', '.') ?> VNĐ</span></div>
                                    <div class="mb5"><span class="text">Tổng Tiền:</span> <span class="text-navy"><?php echo number_format($val['total'], 0, ',', '.') ?> VNĐ</span></div>
                                </td>
                                <td style="color:blue;">
                                    <div class="mb5"><span class="text">Tên miền:</span> <span><?php echo $val['domain'].$val['domain_title'] ?></span></div>
                                </td>
                                <td style="color:blue;">
                                ...
                                <td class="text-center">
                                    <ul class="uk-list lta-tool">
                                        <li>
                                            <a type="button" href="<?php echo base_url('backend/contract/domain/update/'.$val['id']) ?>" class="btn btn-primary open-window" title="Sửa"><i class="fa fa-edit"></i></a>
                                        </li> 
                                        <li>
                                            <a type="button" href="<?php echo base_url('backend/contract/domain/extend/'.$val['id']) ?>" class="btn btn-success open-window"  title="Gia hạn"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
                                        </li>
                                         <li>
                                            <div class="ibox-tools">
                                               ...
                                               <ul class="dropdown-menu dropdown-user">
                                                    <li>
                                                        <a type="button" href="<?php echo base_url('backend/contract/domain/delete/'.$val['id']) ?>" class="open-window" title="Xóa">Xóa</a>
                                                    </li>
