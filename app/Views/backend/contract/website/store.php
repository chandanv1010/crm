					...
					<div class="ibox-content">
						...
						<div class="row">
							...
							<?php if(isset($method) && $method == 'create'){ ?>
								...
								<div class="col-lg-4 ">
									<div class="form-row uk-flex uk-flex-bottom ">
										<a href="<?php echo base_url('backend/contract/hosting/create') ?>" title="Tạo khách hàng" target="_blank" class="va-btn m0 open-window" style="margin:0">Tạo hợp đồng Hosting</a>
									</div>
								</div>
							<?php } ?>
						</div>
